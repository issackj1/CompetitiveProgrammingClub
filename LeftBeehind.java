...
Bill packed his honey in jars, but unfortunately the honey in some of the jars
has turned sour. Bill’s friends are mean, and if too much of Bill’s honey is
sour they will go to the convention without him.
...
Input
Input consists of multiple cases, each on its own line. Each case consists of
two integers x and y (0≤x,y≤1000), which are the number of sweet and sour jars
Bill has, respectively. Input is terminated by a line containing two zeros,
which should not be processed. There may be up to 15 test cases in the input.
...
If Bill’s friends will never speak to him again, that is most important and
